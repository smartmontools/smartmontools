...
const char *knowndrives_c_cvsid="$Id: knowndrives.cpp,v 1.16 2003/04/19 09:53:41 pjwilliams Exp $" ATACMDS_H_CVSID ATAPRINT_H_CVSID KNOWNDRIVES_H_CVSID UTILITY_H_CVSID;
