...
const char *os_XXXX_c_cvsid="$Id: os_darwin.cpp,v 1.10 2004/09/14 03:34:34 ballen4705 Exp $" \
ATACMDS_H_CVSID CONFIG_H_CVSID INT_64_CVSID OS_DARWIN_H_CVSID SCSICMDS_H_CVSID UTILITY_H_CVSID;
