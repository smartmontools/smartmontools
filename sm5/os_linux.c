...
static const char *filenameandversion="$Id: os_linux.c,v 1.67 2004/07/15 09:29:38 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.67 2004/07/15 09:29:38 ballen4705 Exp $" \
