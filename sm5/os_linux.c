...
static const char *filenameandversion="$Id: os_linux.c,v 1.60 2004/07/10 06:32:48 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.60 2004/07/10 06:32:48 ballen4705 Exp $" \
