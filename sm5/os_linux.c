...
static const char *filenameandversion="$Id: os_linux.c,v 1.43 2004/01/13 16:53:06 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.43 2004/01/13 16:53:06 ballen4705 Exp $" \
