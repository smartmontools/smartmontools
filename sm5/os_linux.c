...
static const char *filenameandversion="$Id: os_linux.c,v 1.52 2004/03/25 15:39:25 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.52 2004/03/25 15:39:25 ballen4705 Exp $" \
