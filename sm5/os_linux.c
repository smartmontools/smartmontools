...
static const char *filenameandversion="$Id: os_linux.c,v 1.73 2004/09/14 02:42:16 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.73 2004/09/14 02:42:16 ballen4705 Exp $" \
