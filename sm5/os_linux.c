...
static const char *filenameandversion="$Id: os_linux.c,v 1.78 2005/04/20 03:29:59 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.78 2005/04/20 03:29:59 ballen4705 Exp $" \
