...
static const char *filenameandversion="$Id: os_linux.c,v 1.77 2005/01/14 00:27:51 dpgilbert Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.77 2005/01/14 00:27:51 dpgilbert Exp $" \
