...
static const char *filenameandversion="$Id: os_linux.c,v 1.74 2004/09/14 03:34:34 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.74 2004/09/14 03:34:34 ballen4705 Exp $" \
