...
static const char *filenameandversion="$Id: os_linux.c,v 1.54 2004/07/09 03:39:52 dpgilbert Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.54 2004/07/09 03:39:52 dpgilbert Exp $" \
