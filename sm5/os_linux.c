...
static const char *filenameandversion="$Id: os_linux.c,v 1.55 2004/07/09 12:38:04 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.55 2004/07/09 12:38:04 ballen4705 Exp $" \
