...
static const char *filenameandversion="$Id: os_linux.c,v 1.68 2004/07/27 15:07:42 chrfranke Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.68 2004/07/27 15:07:42 chrfranke Exp $" \
