...
static const char *filenameandversion="$Id: os_linux.c,v 1.83 2006/06/08 03:14:36 dpgilbert Exp $";

const char *os_XXXX_c_cvsid="$Id: os_linux.c,v 1.83 2006/06/08 03:14:36 dpgilbert Exp $" \
