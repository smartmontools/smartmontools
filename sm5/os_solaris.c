...
static const char *filenameandversion="$Id: os_solaris.c,v 1.19.2.1 2004/08/16 23:57:19 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_solaris.c,v 1.19.2.1 2004/08/16 23:57:19 ballen4705 Exp $" \
