...
static const char *filenameandversion="$Id: smartd.c,v 1.345 2004/10/15 07:57:22 chrfranke Exp $";
...
#endif
const char *smartd_c_cvsid="$Id: smartd.c,v 1.345 2004/10/15 07:57:22 chrfranke Exp $" 
