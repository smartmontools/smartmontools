...
static const char *filenameandversion="$Id: smartd.c,v 1.347 2004/10/15 15:17:25 chrfranke Exp $";
...
#endif
const char *smartd_c_cvsid="$Id: smartd.c,v 1.347 2004/10/15 15:17:25 chrfranke Exp $" 
