...
static const char *filenameandversion="$Id: smartd.c,v 1.344 2004/09/15 10:28:30 chrfranke Exp $";
...
#endif
const char *smartd_c_cvsid="$Id: smartd.c,v 1.344 2004/09/15 10:28:30 chrfranke Exp $" 
