...
static const char *filenameandversion="$Id: smartd.c,v 1.346 2004/10/15 15:02:54 chrfranke Exp $";
...
#endif
const char *smartd_c_cvsid="$Id: smartd.c,v 1.346 2004/10/15 15:02:54 chrfranke Exp $" 
