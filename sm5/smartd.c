...
static const char *filenameandversion="$Id: smartd.c,v 1.297 2004/03/24 21:13:51 chrfranke Exp $";
...
#endif
#endif
const char *smartd_c_cvsid="$Id: smartd.c,v 1.297 2004/03/24 21:13:51 chrfranke Exp $" 
