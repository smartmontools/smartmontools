...
static const char *filenameandversion="$Id: smartd.c,v 1.343 2004/09/15 08:01:31 chrfranke Exp $";
...
#endif
#endif
const char *smartd_c_cvsid="$Id: smartd.c,v 1.343 2004/09/15 08:01:31 chrfranke Exp $" 
