...
const char *knowndrives_c_cvsid="$Id: knowndrives.c,v 1.13 2003/04/17 21:53:00 ballen4705 Exp $" ATACMDS_H_CVSID ATAPRINT_H_CVSID KNOWNDRIVES_H_CVSID UTILITY_H_CVSID;
