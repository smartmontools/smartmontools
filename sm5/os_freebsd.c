...
static const char *filenameandversion="$Id: os_freebsd.c,v 1.38 2004/08/13 12:41:40 arvoreen Exp $";

const char *os_XXXX_c_cvsid="$Id: os_freebsd.c,v 1.38 2004/08/13 12:41:40 arvoreen Exp $" \
