...
static const char *filenameandversion="$Id: os_freebsd.c,v 1.46 2005/04/20 03:29:59 ballen4705 Exp $";

const char *os_XXXX_c_cvsid="$Id: os_freebsd.c,v 1.46 2005/04/20 03:29:59 ballen4705 Exp $" \
