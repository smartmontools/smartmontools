...
const char * smartd_cpp_cvsid = "$Id: smartd.cpp 3594 2012-08-23 20:10:00Z chrfranke $"
  CONFIG_H_CVSID;
...
static void MailWarning(const dev_config & cfg, dev_state & state, int which, const char *fmt, ...){
  char command[2048], message[256], additional[256], fullmessage[1024];
  char original[256], further[256], subject[256], dates[DATEANDEPOCHLEN];
  time_t epoch;
  va_list ap;
