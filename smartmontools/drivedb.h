 ...
 */
  ...
  { "Crucial/Micron BX/MX1/2/3/500, M5/600, 11/1300 SSDs",
    ...
    "Micron_1300_(EE|MT)FDDA[KV](256|512|1T0|2T0)TDL", // tested with Micron_1300_MTFDDAK256TDL/M5MU000,
      // Micron_1300_MTFDDAK1T0TDL/M5MU000
    "", "",
  //"-v 1,raw48,Raw_Read_Error_Rate "
    "-v 5,raw48,Reallocate_NAND_Blk_Cnt "
  //"-v 9,raw24(raw8),Power_On_Hours "
  ...
  },
  {
    ...
    "-v 16,raw48,Spares_Count "
    "-v 17,raw48,Spares_Remaining "
    "-v 100,raw48,Total_Erase_Count "
    "-v 168,raw48,PHY_Error_Count "
    "-v 170,raw48,Bad_Block_Count "
    "-v 172,raw48,Block_Erase_Failed "
    "-v 173,raw48,Max_PE_Count "
    "-v 174,raw48,Unexpected_Power_Loss "
    "-v 175,raw48,Average_Erase_Count "
    "-v 176,raw48,NAND_Endurance "
    "-v 181,raw48,Total_Program_Fail "
    "-v 187,raw48,UECC_Count "
    "-v 194,raw48,Temperature "
    "-v 198,raw48,RAID_Recovery_Count "
    "-v 199,raw48,CRC_Error_Count "
    "-v 202,raw48,Perecent_Life_Used "
    "-v 232,raw48,RAID_Count "
    "-v 234,raw48,Flash_Sectors_Read "
    "-v 235,raw48,Flash_Sectors_Written "
    "-v 241,raw48,Host_Sectors_Written "
    "-v 242,raw48,Host_Sectors_Read "
