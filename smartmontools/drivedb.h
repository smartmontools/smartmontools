 ...
 */
  ...
  { "Samsung based SSDs",
    "SAMSUNG MC(C0E(64|1H)|BQE32)G[58E]M[PX]P-.*|"                      // ?, tested with
      // SAMSUNG MCC0E64G8MPP-0VAD1/PS105D15,
      // SAMSUNG MCC0E1HG5MXP-0VBD3/AD3Q,
      // SAMSUNG MCBQE32G5MPP-0VA00/PS105006
    "SAMSUNG 470 Series SSD|"                                           // 470, tested with
      // SAMSUNG 470 Series SSD/AXM09B1Q (MZ5PA((064|128)HMCD|256HMDR))
    "SAMSUNG MZ[5RU]PA((064|128)HMCD|256HMDR|512HMFU)-.*|"              // probably 470, tested with
      // SAMSUNG MZ5PA256HMDR-01000/AXM0601Q,
      // SAMSUNG MZRPA128HMCD-000S0/AXM0AS1Q
    "Samsung SSD 750 EVO (120|250|500)GB|"                              // 750 EVO, tested with
      // Samsung SSD 750 EVO (120|250|500)GB/MAT01B6Q (MZ7TY(12|25|50)0)
    "SAMSUNG SSD 830 Series|"                                           // 830, tested with
      // SAMSUNG SSD 830 Series/CXM03B1Q (MZ7PC(064HADR|(128|256)HAFU|512HAGU(PM830))
    "SAMSUNG MZ7PC(064HADR|(128|256)HAFU|512HAGU)-.*|"                  // probably 830, tested with
      // SAMSUNG MZ7PC128HAFU-000L1/CXM04L1Q
    "SAMSUNG MZRPC(128HACD|256HADR|512HAFU)-.*|"                        // SLIM 1.8 LIF, tested with
      // SAMSUNG MZRPC512HAFU-000S0/CXM01S1Q
    "Samsung SSD 840 Series|"                                           // 840, tested with
      // Samsung SSD 840 Series/DXT06B0Q (MZ7TD(128|256)HAFV(PM840)|512HAGM(PM841))
    "Samsung SSD 840 EVO (120G|250G|500G|750G|1T)B( mSATA)?|"           // 840 EVO, tested with
      // Samsung SSD 840 EVO 120GB/EXT0AB0Q (MZ7TE120HMGR),
      // Samsung SSD 840 EVO (250G|500G|1T)B/EXT0AB0Q (MZ7TE(25|50|1T)0HMHP),
      // Samsung SSD 840 EVO 750GB/EXT0BB0Q (MZ7TE750HMGS),
      // Ssmsung SSD 840 EVO 120GB mSATA/EXT41B6Q (MZMTE120HMGR),
      // Ssmsung SSD 840 EVO (250G|500G|1T)B mSATA/EXT41B6Q (MZMTE(250|500|1T0)HMHP)
    "Samsung SSD 840 PRO Series|"                                       // 840 PRO, tested with
      // Samsung SSD 840 PRO Series/DXM04B0Q 128GB (MZ7PD128HAFV),
      // Samsung SSD 840 PRO Series/DXM04B0Q (256|512)GB (MZ7PD(256HAPV|512HAGM))
    "Samsung SSD 845DC EVO (240|480|960)GB|"                            // 845DC EVO, tested with
      // Samsung SSD 845DC EVO 960GB/EXT03X3Q (MZ7GE(240HMGR|(480|960)HMHP))
    "Samsung SSD 845DC PRO (400|800)GB|"                                // 845DC PRO, tested with
      // Samsung SSD 845DC PRO 400GB/DXV80X3Q (MZ7WD[48]00HMHP)
    "Samsung SSD 850 EVO (mSATA |M\\.2 )?(120G|250G|500G|1T|2T)B"       // 850 EVO, tested with
      // Samsung SSD 850 EVO (120|250|500)GB)/EMT01B6Q (MZ7LN(12|25|50|1T)0HCHP(PM871)),
      // Samsung SSD 850 EVO 1TB/EMT02B6Q (MZ75E1T0HCHP),
      // Samsung SSD 850 EVO [24]TB/EMT02B6Q (MZ7LM[24]T0HMLP),
      // Samsung SSD 850 EVO mSATA (120|250|500)GB/EMT41B6Q (MZMLN(120|250|500)),
      // Samsung SSD 850 EVO mSATA 1TB/EMT41B6Q (MZMLE1T0),
      // Samsung SSD 850 EVO M.2 (120G|500G|1T)B/EMT21B6Q (MZNLN(12|50|1T)0),
      // Samsung SSD 850 EVO M.2 250GB/EMT21B6Q (MZNLN250HMHQ)
    "Samsung SSD 850 PRO (128G|256G|512G|1T|2T)B|"                      // 850 PRO, tested with
      // Samsung SSD 850 PRO 128GB/EXM01B6Q (MZ7KE(128|256|512)HMHA),
      // Samsung SSD 850 PRO 1TB/EXM01B6Q (MZ7KE1T0HMJB)
    "Samsung SSD 860 EVO (250G|500G|1T|2T|4T)B|"                        // 860 EVO, tested with
      // Samsung SSD 860 EVO (250G|500G|1T|2T|4T)B (MZ7LH(250|500HMJQ|1T0HMLU|2T0|4T0))
    "Samsung SSD 860 PRO (256G|512G|1T|2T|4T)B|"                        // 860 PRO, tested with
      // Samsung SSD 860 PRO (256G|512G|1T|2T|4T)B (MZ7KH(256|512HAJQ|1T0JAJR|2T0|4T0HALS))
    "Samsung SSD 960 EVO (250G|500G|1T)B|"                              // 960 EVO, tested with
      // Samsung SSD 960 EVO (250G|500G|1T)B (MZVLW(250HEHP|500HMJP|1T0HMLH))
    "Samsung SSD 960 PRO (250G|512G|1T|2T)B|"                           // 960 PRO, tested with
      // Samsung SSD 960 PRO (512G|1T|2T)B (MZVKP(512HMHQ|1T0HMJP|2T0HMLP))
    "SAMSUNG SSD PM800 (2\\.5\" |TH )(64|128|256)GB|"                   // PM800, tested with
      // SAMSUNG SSD PM800 TH 64GB/VBM25D1Q,
      // SAMSUNG SSD PM800 TH 128GB/VBM1CH1Q (MMCRE28G8MXP-0VBH1),
      // SAMSUNG SSD PM800 2.5" 128GB/VBM24D1Q (MMCRE28G5MXP-0VBD1)
    "SAMSUNG MM(CRE(64|28|56)|MOE56|DPE56)G[58T][MD][PX]P-.*|"          // PB22-J, tested with
      // SAMSUNG MMCRE28G8MXP-0VBL1/VBM1EL1Q,
      // SAMSUNG MMDOE56G5MXP-0VBD1/VBM1AD1Q,
      // SAMSUNG MMDPE56GTDXP-MVBD1/VBM24D1Q
    "SAMSUNG SSD PM810 (2\\.5\" |mSATA )(64|128|256)GB|"                // PM810, tested with
      // SAMSUNG SSD PM810 2.5" 128GB/AXM06D1Q
    "SAMSUNG MZ[7M]PA((064|256)HMDR|128HMFU)-.*|"                       // probably PM810, tested with
      // SAMSUNG MZMPA064HMDR-000D1/AXM18D1Q,
      // SAMSUNG MZMPA128HMFU-00000/AXM1701Q,
      // SAMSUNG MZ7PA256HMDR-010H1/AXM07H1Q
    "SAMSUNG SSD PM830 (2\\.5\" 7mm |mSATA )(064|128|256)GB|"           // PM830, tested with
      // SAMSUNG SSD PM830 mSATA 128GB/CXM12D1Q (MZMPC128HBFU-000D1)
      // SAMSUNG SSD PM830 2.5" 7mm 128GB/CXM03D1Q
    "SAMSUNG MZ[7M]PC(032HBCD|064HBDR|128HBFU|256HBGJ|512HAGH)-.*|"     // probably PM830, tested with
      // SAMSUNG MZMPC032HBCD-000L1/CXM12L1Q,
      // SAMSUNG MZMPC256HBGJ-000H1/CXM12H1Q
    "SAMSUNG MZ7TD((032|064|128|256)HAFV)-.*|"                          // PM840, tested with
      // SAMSUNG MZ7TD256HAFV-000L7/DXT06L6Q
    "SAMSUNG MZ7TD((032|064|128|256)HAFV|512HAG[LM])-.*|"               // PM841, tested with
      // SAMSUNG MZ7TD512HAGM-000L1/DXT05L0Q,
      // SAMSUNG MZMTD512HAGL-00000/DXT4200Q,
      // SAMSUNG MZNTD512HAGL-00000/DXT2300Q
    "SAMSUNG MZ7TD(120)HA(FV|GM)-.*|"                                   // PM843, tested with
      // SAMSUNG MZ7TD120HAFV-000DA/DXT05W1Q
    "SAMSUNG SSD PM851 (mSATA |M\\.2 2280 )(128|256|512)GB|"            // PM851, tested with
      // SAMSUNG SSD PM851 mSATA 128GB,
      // SAMSUNG SSD PM851 M.2 2280 256GB/EXT25D0Q
    "SAMSUNG MZ[7N]TE(128HMGR|(256|512|1T0)HMHP)-.*|"                   // probably PM851, tested with
      // SAMSUNG MZ7TE256HMHP-000L7/EXT09L6Q,
      // SAMSUNG MZNTE256HMHP-000H1/EXT22H0Q
    "SAMSUNG MZ7GE(240|480|960)HM(GR|HP)-.*|"                           // PM853T, tested with
      // SAMSUNG MZ7GE240HMGR-0003/EXT0303Q
    "SAMSUNG MZ[78]LM(120HCFD|240HCGR|(480|960)HCHP|(1T9|3T8)HCJM)-.*|" // PM863, tested with
      // SAMSUNG MZ7LM960HCHP-0E003/GXT3003Q
    "SAMSUNG MZ7LM((240|480)HMHQ|(960|1T9)HMJP|3T8HMLP)-.*|"            // PM863a, tested with
      // SAMSUNG MZ7LM1T9HMJP-00005/GXT5003Q
    "SAMSUNG SSD PM871 (2\\.5 7mm |M\\.2 2280 )(128|256|512)GB|"        // PM871, tested with
      // SAMSUNG SSD PM871 2.5 7mm 256GB/EMT02D0Q
    "SAMSUNG MZ[7N]LN((128|256|512)HCHP(128HCGR|512HCJH))-.*|"          // PM871, tested with
      // SAMSUNG MZ7LN128HCHP-00000/EMT0100Q
    "SAMSUNG MZ[7N]LN(256HMHQ|(512|1T0)HMJP)-.*|"                       // PM871a, tested with
      // SAMSUNG MZ7LN256HMJP-00000/MAV0100Q,
      // SAMSUNG MZ7LN512HMJP-00000/MAV0100Q,
      // SAMSUNG MZNLN256HMHQ-000H1/MAV21H3Q
    "SAMSUNG MZ[7N]LN(128HAHQ|(256|512|1T0)HAJQ|1T0HALR)-.*|"           // PM871b, tested with
      // SAMSUNG MZ7LN256HAHQ-000H1/MVT03H6Q,
      // SAMSUNG MZVLW512HMJP-00000/MVT2100Q
    "SAMSUNG MZ7LH((240|480)HAHQ|960HAJR|(1T9|3T8)HMLT)-.*|"            // PM883, tested with
      // SAMSUNG MZ7LM1T9HMJP-00005/GXT5104Q
    "SAMSUNG MZVLV(128HCGR|256HCHP|512HCJH)-.*|"                        // PM951, tested with
      // SAMSUNG MZVLV128HCGR-00000/BXV7000Q
    "SAMSUNG MZVLW(128HEGR|256HEHP|512HMJP|1T0HMLH)-.*|"                // PM961, tested with
      // SAMSUNG MZVLW512HMJP-00000/CXY7301Q

    "SAMSUNG SSD SM841 (mSATA |2\\.5\" 7mm )(128|256|512)GB|"           // SM841, tested with
      // SAMSUNG SSD SM841 mSATA 512GB/DXM43D0Q (MZMPD512HAGL-000D1),
      // SAMSUNG SSD SM841 2.5" 7mm 128GB/DXM01D1Q (MZ7PD128HAFV-000D1),
      // SAMSUNG SSD SM841 2.5" 7mm 128GB/DXM01D1Q (MZ7PD512HAGM-000D1)
    "SAMSUNG SSD SM841N (mSATA |2\\.5 )?(128|256|512)GB|"               // SM841N, tested with
      // SAMSUNG SSD SM841N mSATA 256GB,
      // SAMSUNG SSD SM841N 2.5 7mm 256GB/DXM03D0Q (MZ7PD256HCGM-000D1)
    "SAMSUNG MZ7WD((120|240)HAFV|480HAGM|960HAGP)-.*|"                  // SM843T, tested with
      // SAMSUNG MZ7WD120HAFV-00003/DXM85W3Q
    "SAMSUNG MZ7WD((120|240)HCFV|480HCGM|960HCGP)-.*|"                  // SM843Tn, tested with
      // SAMSUNG MZ7WD120HCFV-00003/DXM9203Q
    "SAMSUNG MZ7GE(240HMGR|(480|960)HMHP)-.*|"                          // SM853T, tested with
      // SAMSUNG MZ7GE240HMGR-00003/EXT0303Q
    "SAMSUNG MZ7KM(120HAFD|240HAGR|(480|960)HAHP|1T9HAJM)-.*|"          // SM863, tested with
      // SAMSUNG MZ7KM480HAHP-0E005/GXM1003Q
    "SAMSUNG MZ7KM((240|480)HMHQ|(960|1T9)HMJP)-.*|"                    // SM863a, tested with
      // SAMSUNG MZ7KM240HMHQ-00005/GXM5104Q
    "SAMSUNG MZ[HV]PV(128HDGM|(256|512)HDGL)-.*|"                       // SM951, tested with
      // SAMSUNG MZHPV512HDGL-00000/BXW2500Q
    "SAMSUNG MZV(PW128HWGM|PW256HEGL|KW512HMJP|KW1T0HMLH)-.*|"          // SM961, tested with
      // SAMSUNG MZVPW256HEGL-00000/CXZ7100Q,
      // SAMSUNG MZVKW512HMJP-00000/CXA7300Q
    "SAMSUNG MZ[AM]PF0(16HCDD|32HCFV|64HCGM)-.*|"                       // CM851, tested with
      // SAMSUNG MZAPF016HCDD-000H1/FXM21H0Q,
      // SAMSUNG MZMPF032HCFV-000D1/FXM43D2Q
    "SAMSUNG MZ[7N]LF(064HCGR|12[08]HCHP|192HCGS)-.*|"                  // CM871, tested with
      // SAMSUNG MZ7LF128HCHP-00000/FXT0101Q,
      // SAMSUNG MZNLF128HCHP-000H1/FXT21H1Q
    "SAMSUNG MZ[7N]TY(128|256)HDHP-.*|"                                 // CM871a, tested with
      // SAMSUNG MZ7TY256HDHP-00000/MAT01000,
      // SAMSUNG MZNTY256HDHP-000KN/MAT21K0Q
    "SAMSUNG MZ7WD(480|960)HMHP-.*|"                                    // SV843, tested with
      // SAMSUNG MZ7WD480HMHP-00003/DXV8C03Q
    "SAMSUNG MZHPU(128|256|512)HCG[LM]-.*",                             // XP941, tested with
      // SAMSUNG MZHPU256HCGL-000H1/UXM62H1Q
    "", "",
  //"-v 5,raw16(raw16),Reallocated_Sector_Ct "
  //"-v 9,raw24(raw8),Power_On_Hours "
  //"-v 12,raw48,Power_Cycle_Count "
